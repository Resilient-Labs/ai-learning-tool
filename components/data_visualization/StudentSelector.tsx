          ...
          {selectedStudent ? (
            <div>
              ...
              <p className="text-sm text-gray-500">
                {selectedStudent.data.lessonsCompleted} lessons completed
              </p>
            </div>
          ) : (
            <div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {student.data.lessonsCompleted} lessons completed • Last active: {new Date(student.data.activity.lastActiveAt).toLocaleDateString()}
                    </p>
                  </div>
